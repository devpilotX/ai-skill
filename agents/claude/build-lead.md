...
skills: build-pilot, deep-research, reality-check, arch-decide, security-hardening, frontend-build, backend-build, data-layer, infra-deploy, test-strategy, code-review, ship-audit, release-manage, observability-setup
---
